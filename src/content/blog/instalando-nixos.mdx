...
<Code lang="bash" filename="Directory Structure">
```bash
├── home
│   ├── editors
│   ├── profiles
...
<Code lang="text" filename="system/">
```md
| Name     | Description              |
| -------- | ------------------------ |
